...
public class QuadernoAdapter extends RecyclerView.Adapter<QuadernoAdapter.ViewHolder> implements Filterable {
	...
	QuadernoAdapter(Context context, List<Note> data, boolean sharedOnly) {
	...
	public Filter getFilter() {
		return new Filter() {
			...
			protected FilterResults performFiltering(CharSequence charSequence) {
				...
				noteList = Quaderno.getAllNotes(sharedOnly);
				if( !query.isEmpty() ) {
