...
public class NotesFragment extends Fragment implements NotesAdapter.ItemClickListener {
	...
	// Create a new shared note, attached or not to a container.
